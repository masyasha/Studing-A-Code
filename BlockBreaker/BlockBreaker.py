...
level_speedup = 1.5
powerup_chance = 0.1
filter_names = ['Standart', 'Borin', 'Freak Like U', 'Cotic', 'Nice One']
...
class Game (Scene):
	def setup(self):
		...
		self.hud_hearts = [SpriteNode('plf:HudHeart_full', position = (30 + i * 32, self.size.h - 65), scale=0.5, parent=self) for i in xrange(3)]
		...
		self.score_label = LabelNode('kkk', font=('Avenir Next', 40), position=(self.size.w/2, self.size.h-50), parent=self)
